...
const (
	...
	EnvK8SNamespace = "KUBERNETES_NAMESPACE"
...
func NewCertWatcher(ctx context.Context, config *rest.Config, container *restful.Container) *CertWatcher {
	logger := logging.FromContext(ctx)
	secretName, err := getCertSecretName()
	if err != nil {
...
// PodNamespace returns the namespace of the pod.
...
func getCertSecretName() (string, error) {
