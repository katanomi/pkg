...
//go:generate ../../../../../../bin/mockgen -source=archive.go -destination=../../../../../../testing/mock/github.com/katanomi/pkg/storage/client/versioned/archive/v1alpha1/interface.go -package=v1alpha1 ArchiveInterface
