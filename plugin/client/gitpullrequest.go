...
//
//go:generate mockgen -source=gitpullrequest.go -destination=../../testing/mock/github.com/katanomi/pkg/plugin/client/gitpullrequest.go -package=client ClientGitPullRequest
