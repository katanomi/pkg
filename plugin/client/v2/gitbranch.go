...
func (p *PluginClientV2) ListGitBranch(ctx context.Context, branchOption metav1alpha1.GitBranchOption, option metav1alpha1.ListOptions) (metav1alpha1.GitBranchList, error) {
...
func (p *PluginClientV2) GetGitBranch(ctx context.Context, repo metav1alpha1.GitRepo, branch string) (metav1alpha1.GitBranch, error) {
...
func (p *PluginClientV2) CreateGitBranch(ctx context.Context, payload metav1alpha1.CreateBranchPayload) (metav1alpha1.GitBranch, error) {
	branchObj := metav1alpha1.GitBranch{}
