...
func (p *PluginClientV2) GetProjectArtifactFile(ctx context.Context, params metav1alpha1.ProjectArtifactOptions) (io.ReadCloser, error) {
...
func (p *PluginClientV2) ListProjectArtifacts(ctx context.Context, params metav1alpha1.ArtifactOptions, option metav1alpha1.ListOptions) (*metav1alpha1.ArtifactList, error) {
...
func (p *PluginClientV2) UploadArtifact(ctx context.Context, params metav1alpha1.ProjectArtifactOptions, r io.Reader) error {
...
func (p *PluginClientV2) GetProjectArtifact(ctx context.Context, params metav1alpha1.ProjectArtifactOptions) (*metav1alpha1.Artifact, error) {
...
func (p *PluginClientV2) DeleteProjectArtifact(ctx context.Context, params metav1alpha1.ProjectArtifactOptions) error {
	uri := fmt.Sprintf("projects/%s/artifacts/%s", params.Project, url.PathEscape(params.Artifact))
