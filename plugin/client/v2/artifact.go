...
func (p *PluginClientV2) ListArtifacts(ctx context.Context, params metav1alpha1.ArtifactOptions, option metav1alpha1.ListOptions) (*metav1alpha1.ArtifactList, error) {
...
func (p *PluginClientV2) GetArtifact(ctx context.Context, params metav1alpha1.ArtifactOptions) (*metav1alpha1.Artifact, error) {
...
func (p *PluginClientV2) DeleteArtifact(ctx context.Context, params metav1alpha1.ArtifactOptions) error {
	uri := fmt.Sprintf("projects/%s/repositories/%s/artifacts/%s", params.Project, params.Repository, params.Artifact)
...
func (p *PluginClientV2) DeleteArtifactTag(ctx context.Context, params metav1alpha1.ArtifactTagOptions) error {
