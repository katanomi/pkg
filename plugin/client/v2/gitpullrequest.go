...
func (p *PluginClientV2) CreatePullRequest(ctx context.Context, payload metav1alpha1.CreatePullRequestPayload) (metav1alpha1.GitPullRequest, error) {
...
func (p *PluginClientV2) ListGitPullRequest(ctx context.Context, option metav1alpha1.GitPullRequestListOption, listOption metav1alpha1.ListOptions) (metav1alpha1.GitPullRequestList, error) {
...
func (p *PluginClientV2) GetGitPullRequest(ctx context.Context, option metav1alpha1.GitPullRequestOption) (metav1alpha1.GitPullRequest, error) {
	pr := metav1alpha1.GitPullRequest{}
...
func (p *PluginClientV2) CreatePullRequestComment(ctx context.Context, payload metav1alpha1.CreatePullRequestCommentPayload) (metav1alpha1.GitPullRequestNote, error) {
...
func (p *PluginClientV2) UpdatePullRequestComment(ctx context.Context, payload metav1alpha1.UpdatePullRequestCommentPayload) (metav1alpha1.GitPullRequestNote, error) {
	note := metav1alpha1.GitPullRequestNote{}
	options := []base.OptionFunc{base.BodyOpts(payload.CreatePullRequestCommentParam), base.ResultOpts(&note)}
	if payload.Repository == "" {
		return note, errors.NewBadRequest("repo is empty string")
...
func (p *PluginClientV2) ListPullRequestComment(ctx context.Context, option metav1alpha1.GitPullRequestOption, listOption metav1alpha1.ListOptions) (metav1alpha1.GitPullRequestNoteList, error) {
