...
func (p *PluginClientV2) GetGitRepositoryFileTree(ctx context.Context, option metav1alpha1.GitRepoFileTreeOption, listOption metav1alpha1.ListOptions) (metav1alpha1.GitRepositoryFileTree, error) {
