...
const (
	// TestCaseStepTypeItem is the type of test case item
	TestCaseStepTypeItem = "item"
	// TestCaseStepTypeGroup is the type of test case group
	TestCaseStepTypeGroup = "group"
	// TestCaseStepTypeStep is the type of test case step
	TestCaseStepTypeStep = "step"
)
...
type TestCaseSpec struct {
	...
	// Summary is the summary of the test case
	// +optional
...
type TestCaseStepInfo struct {
	...
	ID string `json:"id"`
	// Type could be "step", "item" or "group"
	Type string `json:"type"`
	// ParentID is the group id of this step
	// +optional
