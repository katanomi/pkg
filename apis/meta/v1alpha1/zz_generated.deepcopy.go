...
func (in *BuildGitCommitStatus) DeepCopyInto(out *BuildGitCommitStatus) {
	*out = *in
	...
	if in.PullRequests != nil {
		...
		*out = make([]BuildGitPullRequestStatus, len(*in))
		copy(*out, *in)
	}
}
...
func (in *CancelledBy) DeepCopyInto(out *CancelledBy) {
	*out = *in
	...
	if in.CancelledTimestamp != nil {
		in, out := &in.CancelledTimestamp, &out.CancelledTimestamp
		*out = (*in).DeepCopy()
	}
}
...
func (in *CreateGitRepositoryPayload) DeepCopy() *CreateGitRepositoryPayload {
	...
	out := new(CreateGitRepositoryPayload)
	in.DeepCopyInto(out)
	return out
}
...
func (in DisplayColumns) DeepCopyInto(out *DisplayColumns) {
	{
		in := &in
		*out = make(DisplayColumns, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GitRevisionList) DeepCopyInto(out *GitRevisionList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]GitRevisionDetail, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ListOptions) DeepCopyInto(out *ListOptions) {
	*out = *in
	in.SubResourcesOptions.DeepCopyInto(&out.SubResourcesOptions)
	if in.Search != nil {
...
func (in *Metadata) DeepCopyInto(out *Metadata) {
	*out = *in
	in.PipelineTaskMetadata.DeepCopyInto(&out.PipelineTaskMetadata)
}
...
func (in *ParamSpec) DeepCopyInto(out *ParamSpec) {
	*out = *in
	if in.Properties != nil {
		in, out := &in.Properties, &out.Properties
		*out = make(map[string]v1beta1.PropertySpec, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
func (in *ProjectArtifactOptions) DeepCopy() *ProjectArtifactOptions {
	...
	out := new(ProjectArtifactOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProjectSpec) DeepCopyInto(out *ProjectSpec) {
	*out = *in
	...
	if in.ExtendedAddresses != nil {
		in, out := &in.ExtendedAddresses, &out.ExtendedAddresses
		*out = make(map[ExtendedAddress]*duckv1.Addressable, len(*in))
		for key, val := range *in {
			var outVal *duckv1.Addressable
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
func (in *TestCaseExecutionSpec) DeepCopyInto(out *TestCaseExecutionSpec) {
	*out = *in
	...
	if in.Steps != nil {
		...
		*out = make([]TestCaseExecutionStep, len(*in))
		copy(*out, *in)
	}
}
