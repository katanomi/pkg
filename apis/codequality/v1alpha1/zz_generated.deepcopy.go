...
func (in NamedAnalysisResults) DeepCopyInto(out *NamedAnalysisResults) {
	{
		in := &in
		*out = make(NamedAnalysisResults, len(*in))
		for i := range *in {
...
func (in NamedCodeLintResults) DeepCopyInto(out *NamedCodeLintResults) {
	{
		in := &in
		*out = make(NamedCodeLintResults, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in NamedUnitTestsResults) DeepCopyInto(out *NamedUnitTestsResults) {
	{
		in := &in
		*out = make(NamedUnitTestsResults, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TestResult) DeepCopyInto(out *TestResult) {
	*out = *in
	if in.ReportFiles != nil {
		in, out := &in.ReportFiles, &out.ReportFiles
		*out = make([]ReportFile, len(*in))
		copy(*out, *in)
	}
}
