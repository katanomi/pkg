...
//
//	mockgen -source=interface.go -destination=../../../../../testing/mock/github.com/katanomi/pkg/plugin/storage/capabilities/filestore/v1alpha1/interface.go -package=v1alpha1 FileStoreCapable
//
...
func (mr *MockFileStoreCapableMockRecorder) DeleteFileObject(ctx, objectName any) *gomock.Call {
...
func (mr *MockFileStoreCapableMockRecorder) GetFileMeta(ctx, objectName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreCapableMockRecorder) GetFileObject(ctx, objectName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreCapableMockRecorder) ListFileMetas(ctx, opt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreCapableMockRecorder) PutFileObject(ctx, obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// DeleteFileObject indicates an expected call of DeleteFileObject.
func (mr *MockFileObjectInterfaceMockRecorder) DeleteFileObject(ctx, objectName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetFileObject indicates an expected call of GetFileObject.
func (mr *MockFileObjectInterfaceMockRecorder) GetFileObject(ctx, objectName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// PutFileObject indicates an expected call of PutFileObject.
func (mr *MockFileObjectInterfaceMockRecorder) PutFileObject(ctx, obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetFileMeta indicates an expected call of GetFileMeta.
func (mr *MockFileMetaInterfaceMockRecorder) GetFileMeta(ctx, objectName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ListFileMetas indicates an expected call of ListFileMetas.
func (mr *MockFileMetaInterfaceMockRecorder) ListFileMetas(ctx, opt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
