...
//
//	mockgen -source=filemeta.go -destination=../../../../../../testing/mock/github.com/katanomi/pkg/plugin/storage/client/versioned/filestore/v1alpha1/filemeta.go -package=v1alpha1 FileMetaInterface
//
...
func (mr *MockFileMetaInterfaceMockRecorder) GET(ctx, key any) *gomock.Call {
...
func (mr *MockFileMetaInterfaceMockRecorder) List(ctx, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
