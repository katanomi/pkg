...
//
//	mockgen -source=filestore_client.go -destination=../../../../../../testing/mock/github.com/katanomi/pkg/plugin/storage/client/versioned/filestore/v1alpha1/filestore_client.go -package=v1alpha1 FileStoreV1alpha1Interface
//
...
func (mr *MockFileStoreV1alpha1InterfaceMockRecorder) FileMeta(pluginName any) *gomock.Call {
...
func (mr *MockFileStoreV1alpha1InterfaceMockRecorder) FileObject(pluginName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// FileObject indicates an expected call of FileObject.
func (mr *MockFileObjectGetterMockRecorder) FileObject(pluginName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// FileMeta indicates an expected call of FileMeta.
func (mr *MockFileMetaGetterMockRecorder) FileMeta(pluginName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
