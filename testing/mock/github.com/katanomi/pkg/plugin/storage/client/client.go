...
func (mr *MockInterfaceMockRecorder) Delete(ctx, path interface{}, options ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) ForGroupVersion(gv interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) Get(ctx, path interface{}, options ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, path}, options...)
...
func (mr *MockInterfaceMockRecorder) GetResponse(ctx, path interface{}, options ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, path}, options...)
...
func (mr *MockInterfaceMockRecorder) Post(ctx, path interface{}, options ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, path}, options...)
...
func (mr *MockInterfaceMockRecorder) Put(ctx, path interface{}, options ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, path}, options...)
