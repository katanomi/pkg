...
//
//	mockgen -source=gitcontent.go -destination=../../testing/mock/github.com/katanomi/pkg/plugin/client/gitcontent.go -package=client ClientGitContent
//
...
func (mr *MockClientGitContentMockRecorder) Create(ctx, baseURL, payload any, options ...any) *gomock.Call {
...
func (mr *MockClientGitContentMockRecorder) Get(ctx, baseURL, option any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
