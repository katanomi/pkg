...
//
//	mockgen -package=types -destination=../../testing/mock/github.com/katanomi/pkg/plugin/types/auth.go github.com/katanomi/pkg/plugin/types AuthChecker,AuthTokenGenerator
//
...
func (mr *MockAuthCheckerMockRecorder) AuthCheck(arg0, arg1 any) *gomock.Call {
...
func (mr *MockAuthTokenGeneratorMockRecorder) AuthToken(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
