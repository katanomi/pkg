...
//
//	mockgen -destination=../../testing/mock/k8s.io/cli-runtime/pkg/genericclioptions/config_flags.go -package=genericclioptions k8s.io/cli-runtime/pkg/genericclioptions RESTClientGetter
//
