...
// ------- Attention -
// This type definition was copied from the original
// https://github.com/kubernetes-retired/cluster-registry/blob/master/pkg/apis/clusterregistry/v1alpha1/types.go
// to avoid adding a dependency that is not being maintained anymore
// and its main purpose is to avoid using unstructured Nested* methods
// and have a json mashaling of the data
